...
import 'package:untitled7/recurring%20Evaluation%20method%20page.dart';
...
class Recurringtaskspage extends StatelessWidget {
  final List<Category> categories = [
    ...
    Category("Finance", Iconsax.dollar_circle, Colors.green),
    Category("Health", Iconsax.health, Colors.lightGreen),
    Category("Work", Iconsax.briefcase, Colors.green.shade800),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const RecuuringEvaluationMethodPage()),
        );
      },
      child: Container(
